...
void main() {
  ...
  group('cacheFirstTimer', () {
    ...
    test('should throw a [CacheException when there is error cacheing data]',
        () async {
  ...
  group('checkIfUserIsFirstTimer', () {
    test(
        ...
        ' return right response from storage when data exists', () async {
    ...
    test('should throw a [CacheException] when there is  error '
        'retrieving the data',
         () async {
